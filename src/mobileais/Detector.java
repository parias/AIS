...
public class Detector {
    ...
    public Detector splitUpSTD(App app, ArrayList<Double> std, double T, ArrayList<Integer> max) {
        Detector detector = new Detector();
    ...
    public Detector splitDownSTD(App app, ArrayList<Double> std, double T) {
        Detector detector = new Detector();
